/**
 * Robotech Character Builder - Type Definitions
 * Punto 3: Tipos base con tipos marcados (branded types)
 */
...
/**
 * NOTA: Esta es la base de tipos.
 * Próximas fases crearán interfaces formales en src/domain/
 */
